  ...
  <body id="login">
    <div class="container">
      ...
      <form id="login_form" class="form-signin" method="post">
        <h3 class="form-signin-heading"><i class="icon-lock"></i> Administrator Login</h3>
        ...
        <button name="login" class="btn btn-info" type="submit"><i class="icon-signin icon-"></i> Sign in</button>
			...
			jQuery("#login_form").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome to Administrator Learning Management System Panel", { header: 'Access Granted' });
						var delay = 2000;
